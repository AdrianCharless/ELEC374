...
module mfhi_tb;
    ...
    initial begin
        $monitor("time=%0t | state=%0d | PC=%h | IR=%h | HI=%h | R3=%h",
                 $time, Present_state, DUT.BusMuxIn_PC, DUT.IR, DUT.BusMuxIn_HI, DUT.BusMuxIn_R3);
    end
    ...
    initial begin
        ...
        // mfhi R3 => opcode 11000, Ra=0011
        DUT.MEM.mem[9'h000] = 32'hC1800000;
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            Init1a: DUT.BusMuxIn_HI = 32'h12345678;
