...
module brnz_tb;
    ...
    initial begin
        ...
        // Replace this with the actual encoding for: brnz R3,48
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // T3: Gra, Rout, CONin
            // R3 -> Bus, evaluate brnz, store result in CON
            T3: begin
                Gra   = 1;
                Rout  = 1;
                CONin = 1;
            ...
            Done: begin
                ...
                $display("Expected for taken brnz with PC=0, offset=48: PC should go 0 -> 1 -> 49 (0x31)");
                #20 $stop;
            end
        endcase
    end
