...
// ============================================================================
// Testbench: andi R7, R4, 0x71
//
// Expected: R7 = R4 & 0x71 = 0x14 & 0x71 = 0x10
// ============================================================================
...
module andi_tb;
    ...
    initial begin
        ...
        // andi R7, R4, 0x71
        // opcode=01010, Ra=R7=0111, Rb=R4=0100, C=0x71=19'b000_0000_0111_0001
        // full IR = 01010_0111_0100_0000000001110001 = 32'h52A00071
        DUT.MEM.mem[9'h000] = 32'h52A00071;
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // T4: Cout, AND, Zin -- C_sign_extended(0x71) on bus, Y&Bus -> Z
            T4: begin
                Cout = 1;
                AND  = 1;
                Zin  = 1;
            ...
            Done: begin
                $display("ANDI result: R7 = %h (expected 00000010)", DUT.BusMuxIn_R7);
                #20 $stop;
            end
        endcase
    end
