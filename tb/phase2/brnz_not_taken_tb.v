...
// =============================================================================
// Testbench: brnz R3, 48   (branch NOT taken, R3 = 0)
//
// Encoding: 32'hA9C00030
// Pre-loaded: R3=0 (zero -> branch NOT taken), PC=0
...
module brnz_nt_tb;
    ...
    initial begin
        ...
        #25;
        $display("==============================================");
        $display("TEST: brnz R3, 48  (branch NOT taken, R3=0)");
