...
// Expected: R7 = R4 + (-9) = 20 + (-9) = 11 = 0x0000000B
// ============================================================================
...
module addi_tb;
    ...
    initial begin
        ...
        // addi R7, R4, -9
        // opcode=01001, Ra=R7=0111, Rb=R4=0100, C=-9=19'b111_1111_1111_1111_0111
        // full IR = 01001_0111_0100_1111111111110111 = 32'h49A7FFF7
        DUT.MEM.mem[9'h000] = 32'h49A7FFF7;
    ...
    always @(Present_state) begin
        ...
        case (Present_state)
            ...
            // T4: Cout, ADD, Zin -- C_sign_extended(-9) on bus, Y+Bus -> Z
            T4: begin
                Cout = 1;
                ADD  = 1;
                Zin  = 1;
            ...
            Done: begin
                $display("ADDI result: R7 = %h (expected 0000000B)", DUT.BusMuxIn_R7);
                #20 $stop;
            end
        endcase
    end
