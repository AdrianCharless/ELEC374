...
// =============================================================================
// Testbench: brpl R3, 48   (branch NOT taken, R3 = 0xFFFFFFFF, negative)
//
// Encoding: 32'hA9A00030
// Pre-loaded: R3=0xFFFFFFFF (-1, negative -> branch NOT taken), PC=0
// Expected: PC = 1 (stays at PC+1, no branch)
// =============================================================================
...
module brpl_nt_tb;
    ...
    initial begin
        ...
        // brpl R3, 48 = 32'hA9A00030
        DUT.MEM.ram.mem[9'h000] = 32'hA9A00030;

        #35 clear = 0;
        force DUT.R3.q = 32'hFFFFFFFF;   // -1 (negative) -> branch NOT taken
    ...
    initial begin
        ...
        #25;
        $display("==============================================");
        $display("TEST: brpl R3, 48  (branch NOT taken, R3=0xFFFFFFFF)");
        ...
        if (DUT.BusMuxIn_PC === 32'h00000001)
            $display("  ** PASS **");
        else
            $display("  ** FAIL **");
        $display("==============================================");
