...
// =============================================================================
// Testbench: brzr R3, 48   (branch NOT taken, R3 != 0)
//
// Encoding: 32'hA9800030
// Pre-loaded: R3=5 (non-zero -> branch NOT taken), PC=0
...
module brzr_nt_tb;
    ...
    initial begin
        ...
        #35 clear = 0;
        force DUT.R3.q = 32'h00000005;   // R3 != 0 -> branch NOT taken
    ...
    initial begin
        ...
        #25;
        $display("==============================================");
        $display("TEST: brzr R3, 48  (branch NOT taken, R3=5)");
